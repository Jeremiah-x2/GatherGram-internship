...
export default function Features() {
  return (
    <section className="px-8 lg:px-16 py-[100px] space-y-12 lg:space-y-[100px] bg-[#F2F4F5]">
      <div className="text-center space-y-10">
        <h3 className="font-bold text-[30px]">Our Features</h3>
        <p className="max-w-[750px] mx-auto text-lg lg:text-[22px]">
          &quot;Easily create and manage your wedding events, from the ceremony
          to the reception.&quot;
        </p>
      </div>
      <div className="bg-[#212121] min-h-[460px] pl-[35px] pt-4 gap-x-[70px] gap-y-8 text-white grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
