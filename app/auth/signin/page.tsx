...
export default function SignIn() {
  ...
  return (
    <>
      {showWelcome && (
        <Welcome setShowWelcome={setShowWelcome} userName={"Back"} />
      )}
      <div className="flex min-h-[100dvh] w-full relative gap-[74p">
        <div className="min-w-[50%] max-w-[720px] max-h-[1024px] hidden lg:block  overflow-hidden relative">
          <Image
        ...
        <div className="flex-1 gap-[12px] px-8 lg:px-[74px] py-[64px] h-full overflow-hidden">
          ...
          <div className="mb-[30px]">
            <h3 className="text-[30px] font-bold text-[#110D06]">
              Get Started
            </h3>
            <p className="max-w-[455px] text-base font-normal">
              Enter your email address below to login to existing account or
